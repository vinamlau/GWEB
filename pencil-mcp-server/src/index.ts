...
async function main() {
  ...
  console.error(`模式：${pencilAvailable ? '✅ Pencil CLI 模式' : '⚠️ 模拟模式 (需要安装 Pencil IDE 插件)'}`);
}
